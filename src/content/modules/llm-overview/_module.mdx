...
A 15-minute conversational tour of this module, generated with NotebookLM. Good for tube journeys.

<audio controls preload="metadata" src={`${import.meta.env.BASE_URL}audio/module-1/overview.mp3`}></audio>
